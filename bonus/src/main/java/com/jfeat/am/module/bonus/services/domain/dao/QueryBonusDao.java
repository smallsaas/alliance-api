...
public interface QueryBonusDao {
    ...
    List<ProductSalesRecord> querySales(@Param("pageNum") Integer pageNum, @Param("pageSize") Integer pageSize, @Param("search") String search,@Param("leftMoney") BigDecimal leftMoney,
